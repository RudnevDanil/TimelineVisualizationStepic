...
d3.csv("dji.csv", function(error, csv) {
  ...
  function mouseout (d) 
  {
	...
	d3.selectAll(".q0-11").style("fill", "rgb(165,0,38)");
	d3.selectAll(".q1-11").style("fill", "rgb(215,48,39)");
	d3.selectAll(".q2-11").style("fill", "rgb(244,109,67)");
	d3.selectAll(".q3-11").style("fill", "rgb(253,174,97)");
	d3.selectAll(".q4-11").style("fill", "rgb(254,224,139)");
	d3.selectAll(".q5-11").style("fill", "rgb(255,255,191)");
	d3.selectAll(".q6-11").style("fill", "rgb(217,239,139)");
	d3.selectAll(".q7-11").style("fill", "rgb(166,217,106)");
	d3.selectAll(".q8-11").style("fill", "rgb(102,189,99)");
	d3.selectAll(".q9-11").style("fill", "rgb(26,152,80)");
	d3.selectAll(".q10-11").style("fill","rgb(0,104,55)");
